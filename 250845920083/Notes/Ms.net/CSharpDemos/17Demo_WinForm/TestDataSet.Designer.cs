...
namespace _17Demo_WinForm.TestDataSetTableAdapters {
    ...
    public partial class EmpTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Emp] WHERE (([no] = @Original_no))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Emp] SET [name] = @name, [address] = @address WHERE (([no] = @Origi" +
                "nal_no));\r\nSELECT no, name, address FROM Emp WHERE (no = @no)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_17Demo_WinForm.Properties.Settings.Default.TestConnectionString;
        }
        ...
        public virtual int Fill(TestDataSet.EmpDataTable dataTable) {
        ...
        public virtual TestDataSet.EmpDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDataSet.EmpDataTable dataTable = new TestDataSet.EmpDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDataSet.EmpDataTable dataTable) {
        ...
        public virtual int Update(string name, string address, int Original_no, int no) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, int Original_no) {
            return this.Update(name, address, Original_no, Original_no);
        }
    }
