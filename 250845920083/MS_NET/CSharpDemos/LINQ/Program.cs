...
namespace LINQ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    Console.WriteLine("Heyyy iam Shashank Mankar!");
            //});
            //actionDel();

            //Action del2 = delegate ()
            //{
            //    Console.WriteLine("Hello Soham Shelar!");
            //};
            //del2();

            //Action del3 = () =>
            //{
            //    Console.WriteLine("Hello Pratik Harode!");
            //};
            //del3();

            //Action del4 = () => Console.WriteLine("Hello PRatik Khairwar!");
            //del4();
            #endregion
            ...
            //Func<double> func3 = () => { return 99.99; };
