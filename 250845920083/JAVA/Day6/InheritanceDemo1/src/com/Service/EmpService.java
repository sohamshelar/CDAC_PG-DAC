...
public class EmpService {
   ...
   static {
	   ...
	   emparr[0]=new SalariedEmp("Soham",new Date(2000,04,23),"HR","Designer",88888);
   	   emparr[1]=new SalariedEmp("Shashank",new Date(2000,04,23),"UX","Designer",99999);
	   emparr[2]=new ContractEmp("Yuvraj",new Date(2000,04,23),"HR","Designer",80,3000);
	   emparr[3]=new ContractEmp("Rohit",new Date(2000,04,23),"UX","Designer",80,4000);		   
	   count=4;
   }
	...
	public static boolean modifyById(String id, double charges) {
		...
		if(e!=null) {
			if(e instanceof SalariedEmp) {
				...
				((ContractEmp)e).setCharge(charges);
			}else {
	...
	public static Employee searchByName(String s1) {
		for(Employee e:emparr)
		{
			if(e!=null)
			{
				if(e.getPname().equals(s1))
				{
					return e;
				}
			}
